              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST">
                    ...
                    <div class="form-group"> 
                      <textarea class="form-control" id="programdesc"name="programdesc" rows="4" placeholder="Description of program" autocomplete="off"></textarea>
                    </div>
                    <button type="submit" name="addprogram" class="btn btn-primary mr-2">Submit</button>
...
if(isset($_POST['addprogram']))
{
 ...
 $programdesc = $_POST["programdesc"];
     //echo $sname;
 include 'connection.php';
 $sql = "INSERT IGNORE INTO program(program_name,program_description) VALUES ('$programname','$programdesc')";
 $conn->exec($sql);
 echo "<script>
       Swal.fire({
      icon:'success',
