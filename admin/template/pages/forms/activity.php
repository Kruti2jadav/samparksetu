                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST">
                    <div class="form-group"> 
                      <input type="text" class="form-control" id="activityname" name="activityname" placeholder="Name of activity" required autocomplete="off">
                    </div> 
                    <div class="form-group"> 
                      <textarea class="form-control" id="activitydesc"name="activitydesc" rows="4" placeholder="Description of activity" autocomplete="off"></textarea>
                    </div>
                    <button type="submit" name="addact" class="btn btn-primary mr-2">Submit</button>
...
if(isset($_POST['addact']))
{
 ...
 $actdesc = $_POST["activitydesc"];
     //echo $sname;
 include 'connection.php';
 $sql = "INSERT INTO activity(actname,actdescription) VALUES ('$actname','$actdesc')";
 $conn->exec($sql);
 echo "<script>
       Swal.fire({
      icon:'success',
