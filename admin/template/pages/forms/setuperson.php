...
<div class="container-scroller">
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Setu Person</h4> 
                  <form class="forms-sample" method="POST">
                    <div class="form-group"> 
                      <input type="text" class="form-control" id="name" name="name" 
                      placeholder="Name of setu person" required autocomplete="off">
                    </div>
                    <div class="form-group"> 
                      <input type="text" class="form-control" id="age" name="age" 
                      placeholder="Age of setu person" required autocomplete="off">
                    </div>
                    <div class="form-group"> 
  ...
  <option value="female">Female</option>
                    ...
                    <div class="form-group"> 
                      <input type="text" class="form-control" id="mono" name="mono" required
                      placeholder="Mobile no of setu person" pattern="[0-9]{10}" title="Mobile no must be of 10 digits" autocomplete="off">
                    </div>
                    <div class="form-group"> 
                      <input type="text" class="form-control" id="wpmono" name="wpmono" required
                      placeholder="Whatsapp no of setu person" pattern="[0-9]{10}" title="Whatsapp no must be of 10 digits" autocomplete="off">
                    </div>
                    <div class="form-group"> 
                      <input type="email" class="form-control" id="email" name="email" 
                      placeholder="EmailID of setu person" required autocomplete="off">
                    </div>
                    <div class="form-group"> 
                      <input type="text" class="form-control" id="department" name="department" 
                      placeholder="Department of setu person" required autocomplete="off">
                    </div>
                    <button type="submit" name="addperson" class="btn btn-primary mr-2">Submit</button>
...
if(isset($_POST['addperson']))
{
 ...
 $department = $_POST["department"];
     //echo $sname;
 include 'connection.php';
 $sql = "INSERT INTO setu_person(setu_person_name,age,sex,mobile_no,wpmono,email,department) VALUES ('$name',$age,'$sex','$mono','$wpmono','$email','$department')";
 $conn->exec($sql);
 echo "<script>
       Swal.fire({
      icon:'success',
      text:'Setu person Added Successfully'
      })</script>" ;
}}
