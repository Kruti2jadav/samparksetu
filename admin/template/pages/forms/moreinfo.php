                ...
                <div class="card-body"><center>
                  ...
                  <div class="table-responsive"><center>
                   ...
                   <?php
                         $id = $_POST['sid']; 
                              include 'connection.php';
                              $sql = "SELECT * FROM sampark_form WHERE sampark_id=$id";
                        ...
                        <tr>
                          ...
                          <th>
                             <?php echo $row['fullname']; ?>  </th>
                               </tr>
                               <tr>
                          <th>
                            Age
                          </th> <th>
                             <?php echo $row['age']; ?>  </th></tr>
                             <tr>
                          <th>
                            Gender
                          </th><th>
                             <?php echo $row['sex']; ?>  </th></tr>
                             <tr>
                          <th>
                          Faliyu
                          </th> <th>
                             <?php echo $row['faliyu']; ?>  </th></tr>
                             <tr>
                          <th>
                            Mukam
                          </th> <th>
                             <?php echo $row['mukam']; ?>  </th></tr>
                             <tr>
                          <th>
                            Post
                          </th> <th>
                             <?php echo $row['post']; ?>  </th></tr>
                             <tr>
                          <th>
                            Taluko
                          </th> <th>
                             <?php echo $row['taluko']; ?>  </th></tr>
                             <tr>
                          <th>
                            District
                          </th> <th>
                             <?php echo $row['district']; ?>  </th></tr>
                             <tr>
                          <th>
                            Pincode
                          </th> <th>
                             <?php echo $row['pincode']; ?>  </th></tr>
                             <tr>
                          <th>
                            Occupation
                          </th> <th>
                             <?php echo $row['occupation']; ?>  </th></tr>
                             <tr>
                          <th>
                            M0bile no
                          </th> <th>
                             <?php echo $row['mobileno']; ?>  </th></tr>
                             <tr>
                          <th>
                            Whatsapp no
                          </th> <th>
                             <?php echo $row['whatsappno']; ?>  </th></tr>
                             <tr>
                          <th>
                            EmailID
                          </th> <th>
                             <?php echo $row['emailid']; ?>  </th></tr>
                             <tr>
                          <th>
                            Helpful in activity 
                          </th> <th>
                             <?php echo $row['activity']; ?>  </th></tr>
                             <tr>
                          <th>
                            Present activity
                          </th> <th>
                             <?php echo $row['present_activity']; ?>  </th></tr>
                             <tr>
                          <th>
                             Magazine
                          </th> <th>
                             <?php echo $row['magazine']; ?>  </th></tr>
                             <tr>
                          <th>
                            Invitation in program
                          </th> <th>
                             <?php echo $row['program']; ?>  </th></tr>
                             <tr>
                          <th>
                            Setu person name
                          </th> <th>
                             <?php echo $row['setuperson_name']; ?>  </th></tr>
                             <tr>
                          <th>
                            Department  
                          </th> <th>
                             <?php echo $row['department']; ?>  </th></tr>
                             <tr>
                          <th>
                            Visit date
                          </th> <th>
                             <?php echo $row['visit_date']; ?>  </th></tr>
                             <tr>
                          <th>
                            Data entry operator 
                          </th>
                          <th>
                             <?php echo $row['name_operator']; ?>  </th></tr> <?php }?>
                               </tbody></center>
                    </table>
                  </div>
                </div>
